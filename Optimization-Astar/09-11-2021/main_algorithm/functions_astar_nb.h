...
#define inputfilename "/home/joseba/Master/Master_git/Optimization/Astar_algorithm/construct_graf_CAT/Catalunya.bin"
...
int binary_reader(node *nodes){ 
        FILE *graph;
        unsigned long number_nodes =  3472620, ntotnsucc = 3891647;
