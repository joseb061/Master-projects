...
int main(){
    ...
    // for (v = PathData[node_start_pos].parent; v != node_goal_pos; v = PathData[binarysearch(v,nodes,size_nodes)].parent){
    //     fprintf(sol_save_txt,"\n(%3.3lu) | %7.3f | %7.5f | %7.5f |%s", v, PathData[binarysearch(v,nodes,size_nodes)].g, nodes[binarysearch(v,nodes,size_nodes)].latitude, nodes[binarysearch(v,nodes,size_nodes)].longitude, nodes[binarysearch(v,nodes,size_nodes)].name);           
    // }
    //  fclose(sol_save_txt); 
